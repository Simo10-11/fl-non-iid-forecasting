...
Previsione del traffico di rete (LSTM + PyTorch) sul dataset [CESNET-TimeSeries24](https://github.com/koumajos/CESNET-TimeSeries24), confrontando federated learning (Flower) con un termine di paragone centralizzato. La repo raccoglie i tre esperimenti, ciascuno nella propria cartella autosufficiente (propria configurazione, propria `README.md`):
...
python3 -m venv flwr-env && source flwr-env/bin/activate
pip install -e .
flwr run . --stream
```
